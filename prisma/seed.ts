...
async function main() {
  ...
  // 1. Person 6人
  const peopleRaw = [
    { slug: "alice", displayName: "Alice", isStaff: true, canComment: true, avatarUrl: "alice.svg" },
    { slug: "ben", displayName: "Ben", isStaff: true, canComment: true, avatarUrl: "ben.svg" },
    { slug: "chloe", displayName: "Chloe", isStaff: true, canComment: false, avatarUrl: "chloe.svg" },
    { slug: "daisuke", displayName: "Daisuke", isStaff: true, canComment: false, avatarUrl: "daisuke.svg" },
    { slug: "emi", displayName: "Emi", isStaff: false, canComment: true, avatarUrl: "emi.svg" },
    { slug: "fuji", displayName: "Fuji", isStaff: false, canComment: true, avatarUrl: "fuji.svg" }
  ];
